...
class AchievementsControllerTest < ActionController::TestCase
  ...
  test "should create achievement" do
    assert_difference('Achievement.count') do
      post :create, achievement: { achievement: @achievement.achievement, champ: @achievement.champ, date: @achievement.date, organizer: @achievement.organizer }
    end
  ...
  test "should update achievement" do
    patch :update, id: @achievement, achievement: { achievement: @achievement.achievement, champ: @achievement.champ, date: @achievement.date, organizer: @achievement.organizer }
    assert_redirected_to achievement_path(assigns(:achievement))
  end
