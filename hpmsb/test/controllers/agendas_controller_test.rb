...
class AgendasControllerTest < ActionController::TestCase
  ...
  test "should create agenda" do
    assert_difference('Agenda.count') do
      post :create, agenda: { agenda_id: @agenda.agenda_id, date: @agenda.date, event: @agenda.event, venue: @agenda.venue }
    end
  ...
  test "should update agenda" do
    patch :update, id: @agenda, agenda: { agenda_id: @agenda.agenda_id, date: @agenda.date, event: @agenda.event, venue: @agenda.venue }
    assert_redirected_to agenda_path(assigns(:agenda))
  end
